...
\documentclass[cs4size,openany,twoside,UTF8,space=auto]{ctexbook}
...
\include{body/deep_classifier}
\include{body/deep_embedding}
%\include{body/dict_lib}
\include{body/ensemble}
